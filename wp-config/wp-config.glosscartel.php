...
define('DB_NAME', 'glosscar_newdb');

/** MySQL database username */
define('DB_USER', 'glosscar_newdb');

/** MySQL database password */
define('DB_PASSWORD', ']qV#6W_s-VQe');
...
define("WP_HOME", "http://glosscartel.com/");
define("WP_SITEURL", "http://glosscartel.com/");
